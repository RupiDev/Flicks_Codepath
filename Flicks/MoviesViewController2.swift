//
//  MoviesViewController2.swift
//  Flicks
//
//  Created by Rupin Bhalla on 1/17/16.
...
class MoviesViewController2: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    @IBAction func switchingViews(sender: AnyObject)
    {
        switchView = true;
    }
